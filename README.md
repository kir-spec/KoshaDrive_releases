...
<img src="https://flagcdn.com/20x15/ua.png" alt="UA" width="20" height="15" align="top" /> **KoshaDrive** — хмарний файловий менеджер для Windows: Telegram стає вашим персональним диском із деревом папок, прев’ю, drag-and-drop і синхронізацією. Файли під рукою, а не в історії чатів.

---

## Features / Возможности / Можливості

EN · RU · UA — choose a section below / выберите раздел / оберіть розділ:

<details>
<summary><strong>EN — cloud manager features</strong></summary>
...
<details>
<summary><strong>RU — возможности облачного менеджера</strong></summary>
...
- Локализация **EN / RU / UA**; справка и «О программе» внутри приложения.

### Надёжность
- Обработка **FloodWait**, классификация сетевых ошибок, **1000+ автотестов**.
- Лицензирование v3, демо-режим, защита API-ключей в сборке.

### Установка
1. Скачайте `KoshaDriveSetup_24.06.2026.exe` ниже.
2. Windows 10/11, x64.
...
<details>
<summary><strong>UA — можливості хмарного менеджера</strong></summary>
...
- Локалізація **EN / RU / UA**; довідка та «Про програму» в застосунку.

### Надійність
- Обробка **FloodWait**, класифікація мережевих помилок, **1000+ автотестів**.
- Ліцензування v3, демо-режим, захист API-ключів у збірці.

### Встановлення
1. Завантажте `KoshaDriveSetup_24.06.2026.exe` нижче.
2. Windows 10/11, x64.
...
<details>
<summary><strong>EN — installation and first launch</strong></summary>
...
<details>
<summary><strong>RU — установка и первый запуск</strong></summary>
...
<details>
<summary><strong>UA — встановлення та перший запуск</strong></summary>
...
<details>
<summary><strong>Screenshots / Скриншоты / Скриншоти</strong></summary>

Click thumbnail for full size / Нажмите миниатюру для полного размера / Натисніть мініатюру для повного розміру.
